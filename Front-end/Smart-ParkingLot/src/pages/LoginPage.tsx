...
const LoginPage: React.FC = () => {
  ...
  const handleLogin = async () => {
    if(email === '' && password === ''){
      setUIErrorMessage('Please enter your email address and your password');
    } else if(email === ''){
      setUIErrorMessage('Please enter your email address');
    } else if(password === ''){
      setUIErrorMessage('Please enter your password');
    } else {
      if (isValidEmail(email)) {
          ...
          setUIErrorMessage('Invalid email');
        }
    }
  };
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="relative">
        ...
        <div className="relative w-80 max-w-md p-12 bg-gray-300 dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg rounded-lg">
          ...
          <div className="text-red-500 text-center mb-4">{errorMessage}</div> {/* Display the error message */}
          <button
            onClick={handleLogin}
